<!DOCTYPE html>
  ...
  <div class="container mt-3">
      <div class="row justify-content-center">
        <div class="col-6 fs-3">Liste des disques</div><button type="button" class="btn btn-secondary col-5" style="max-width: 240px" onclick='window.location="add_script.php"'>Ajouter</button>
      </div>
    ...
    <form method='GET' action='details.php' class='mt-3 row justify-content-center'>
        ...
        foreach($result as $row){
            echo '<div class="card mb-3 col-5 mx-4 border border-danger border-4 bg-secondary bg-opacity-50" id="'.$row['disc.id'].'" style="max-width: 540px;">
    <div class="row g-0">
        <div class="col-md-4">
        <img src="pictures/'.$row['disc_picture'].'" class="img-fluid rounded-start mt-4" alt="'.$row['disc_title'].'">
    </div>
        <div class="col-md-8">
        <div class="card-body">
