        ...
        <div class="container">
          <div class="row justify-content-around g-0">
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="image/food/Snack/Burrito.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="image/food/Snack/CroqueMadame.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="image/food/Snack/CroqueMonsieur.jpg" class="card-img border border-secondary border-5" alt="...">
            ...
            <div class="card text-center" style="width: 280px;">
              <div class="card-body">
                <img src="image/food/Snack/Kebab.jpg" class="card-img border border-secondary border-5" alt="...">
        ...
        <section>
          <div class="container">
            <div class="row justify-content-around g-0">
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="image/food/Snack/Nuggets.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="image/food/Snack/Tacos.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="image/food/Snack/TartineChévre.jpg" class="card-img border border-secondary border-5" alt="...">
              ...
              <div class="card text-center" style="width: 280px;">
                <div class="card-body">
                  <img src="image/food/Snack/TartineSaumon.jpg" class="card-img border border-secondary border-5" alt="...">
